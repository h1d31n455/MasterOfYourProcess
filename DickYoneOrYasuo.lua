require("common.log")
module("DickYoneOrYasuo v0.2", package.seeall, log.setup)
--- api
...
function OnLoad() 
	if Player.CharName ~= "Yasuo" or Player.CharName ~= "Yone" then return false end 
	...
	Game.PrintChat("DickYoneOrYasuo v0.2 Loaded !")
